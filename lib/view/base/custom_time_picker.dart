    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      InkWell(
        onTap: () async {
          ...
          if(_time != null) {
            setState(() {
              _myTime = DateFormat('HH:mm').format(DateTime(DateTime.now().year, 1, 1, _time.hour, _time.minute));
            });
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            Text(DateConverter.convertTimeToTime(_myTime), style: robotoRegular),
