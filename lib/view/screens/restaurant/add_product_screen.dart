...
class AddProductScreen extends StatefulWidget {
  ...
  final List<Language> nameList;
  final List<Language> descriptionList;
  AddProductScreen({@required this.product, @required this.nameList, @required this.descriptionList});
...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void initState() {
    ...
    if(_update) {
      ...
      Get.find<RestaurantController>().setVeg(true, false);
