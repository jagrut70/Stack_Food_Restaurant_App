...
class RouteHelper {
  ...
  // }
  static String getAddProductRoute(Product productModel, List<Language> nameList, List<Language> descriptionList) {
    // TODO: add product
    // String _name = base64Encode(utf8.encode(jsonEncode(nameList)));
    // String _description = base64Encode(utf8.encode(jsonEncode(descriptionList)));
    if(productModel == null) {
      // return '$addProduct?data=null&name=$_name&description=$_description';
      return '$addProduct?data=null';
    }
    String _data = base64Encode(utf8.encode(jsonEncode(productModel.toJson())));
    //return '$addProduct?data=$_data&name=$_name&description=$_description';
    return '$addProduct?data=$_data';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: addProduct, page: () {
      // TODO: add product
      // List<Language> _name = [];
      // List<Language> _description = [];
      // jsonDecode(utf8.decode(base64Decode(Get.parameters['name'].replaceAll(' ', '+')))).forEach((data) {
      //   _name.add(Language.fromJson(data));
      // });
      // jsonDecode(utf8.decode(base64Decode(Get.parameters['description'].replaceAll(' ', '+')))).forEach((data) {
      //   _description.add(Language.fromJson(data));
      // });
      if(Get.parameters['data'] == 'null') {
        // return AddProductScreen(product: null, nameList: _name, descriptionList: _description);
        return AddProductScreen(product: null, nameList: [], descriptionList: []);
      }
      List<int> _decode = base64Decode(Get.parameters['data'].replaceAll(' ', '+'));
      Product _data = Product.fromJson(jsonDecode(utf8.decode(_decode)));
      // return AddProductScreen(product: _data, nameList: _name, descriptionList: _description);
      return AddProductScreen(product: _data, nameList: [], descriptionList: []);
    }),
